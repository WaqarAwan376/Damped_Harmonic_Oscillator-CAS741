        ...
        root: (ownerState) => {
          ...
          return {
            ...
            className: clsx(
              ...
              ownerState.focused
                ? "border-violet-400 dark:border-violet-400 dark:shadow-outline-purple"
                : "border-slate-300 dark:border-slate-600 dark:shadow-slate-900",
